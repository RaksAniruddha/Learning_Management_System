...
function Profile() {
    ...
    useEffect(() => {
        if (isSuccess) {
            refetch();
            toast.success(data?.massage || "Profile updated");
        }
        if (isError) {
            toast.error(error?.massage || "Failed to update");
        }
                    ...
                    <Dialog>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>Make Your Profile Here. Click Save When You are done.</DialogDescription>
                            </DialogHeader>
